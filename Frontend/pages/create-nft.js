...
const CreateNFT = () => {
  ...
  const { isLoadingNFT, uploadToIPFS, createNFT,  creatingNft } = useContext(NFTContext);
  ...
  return (
    ...
    currentAccount ? (
      <div className="flex justify-center sm:px-4 p-12">
       ...
       <div className='mt-3 w-full flex justify-end fee' style={{fontSize: 'small'}}>Service fee 0.0002</div>
